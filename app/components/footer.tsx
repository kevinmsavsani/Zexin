      ...
      <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
        ...
        <div className="flex mt-8 flex-col md:flex-row md:justify-between">
          <p className="w-full md:w-2/3 text-gray-400">
            Zexin is one of the fastest-growing pharmaceutical companies in India, with its presence across multiple therapeutic areas
          </p>
          <div className="w-44 pt-6 md:pt-0">
            <a className="bg-red-500 justify-center text-center rounded-lg shadow px-10 py-3 flex items-center" href="/contact-us">
              Contact US
            </a>
          </div>
        </div>
        <div className="flex flex-col">
          <div className="flex mt-24 mb-12 flex-row justify-between">
            <a className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase" href="/about-us">
              About Us
            </a>
            <a className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase" href="/products">
              Products
            </a>
            <a className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase" href="/career">
              Career
            </a>
            <a className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase" href="/contact-us">
              Contact Us
            </a>
